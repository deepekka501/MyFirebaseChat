...
public interface IConstants {
    ...
    String BROADCAST_DOWNLOAD_EVENT = "com.ekkatech.firebase.chat.activities.DOWNLOAD_EVENT";

    String PLAYING_DATA = "playing_data";
    String BROADCAST_PLAY_RECORDING_EVENT = "com.ekkatech.firebase.chat.activities.PLAY_RECORDING_EVENT";
